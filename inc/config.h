...
#define INPUT_CLOSED    1
#define INPUT_OPEN      (1-INPUT_CLOSED)

#define INPUT0_PORT		PORT2
#define INPUT0_CPORT	LPC_GPIO2
#define INPUT0_BIT		4

#define INPUT1_PORT		PORT2
#define INPUT1_CPORT	LPC_GPIO2
#define INPUT1_BIT		5
...
#define INPUT3_PORT		PORT2
#define INPUT3_CPORT	LPC_GPIO2
#define INPUT3_BIT		7
